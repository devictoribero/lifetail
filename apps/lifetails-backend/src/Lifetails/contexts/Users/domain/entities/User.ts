import { EmailValueObject } from 'src/Lifetails/contexts/Shared/domain/EmailValueObject';
import { AggregateRoot } from 'src/Lifetails/contexts/Shared/domain/AggregateRoot';
