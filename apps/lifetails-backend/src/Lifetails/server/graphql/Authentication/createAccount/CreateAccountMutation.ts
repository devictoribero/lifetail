...
import { EmailAlreadyInUseException } from 'src/Lifetails/contexts/Authentication/domain/exceptions/EmailAlreadyInUseException';
import { CreateAccountCommand } from 'src/Lifetails/contexts/Authentication/application/createAccount/CreateAccountCommand';
